...
export default async function LaunchesAdminPage({ searchParams }: { searchParams: Promise<{ key?: string }> }) {
  ...
  return <main className="launch-admin"><header className="launch-admin-head"><div><p>Centro de lanzamientos</p><h1>Una plantilla para cada campaña.</h1><span>Planifica, prepara borradores y coordina automatizaciones con Zernio sin tocar el workshop vigente.</span></div><a href="/ebooks" target="_blank">Ver tienda ↗</a></header>
