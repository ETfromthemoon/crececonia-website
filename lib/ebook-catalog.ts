...
export const EBOOK_CATALOG: EbookCatalogEntry[] = [
  ...
  },
  {
    ...
    title: "Creación de Webs con IA · Parte 2: Sitios Corporativos",
    subject: "Sitios Corporativos con IA",
    href: "/ebook/creacion-de-webs-con-ia-parte-2",
    coverSrc: "/ebooks/creacion-de-webs-con-ia-parte-2.png",
    active: true,
    tierPrices: { superEarly: 9700, early: 13700, regular: 19700 },
    storeProfile: {
      level: "Constructor",
      outcome: "Construir sitios corporativos editables, escalables y listos para clientes.",
      audience: "Si quieres crear sitios corporativos con Astro, CMS y contenido multi-idioma.",
      pageCount: 113,
    },
    visibleFrom: LANZAMIENTO_2026_08_07,
    series: { name: "Creación de Webs con IA", part: 2 },
  },
  {
    resource: "ebook:creacion-de-webs-con-ia-parte-3",
    title: "Creación de Webs con IA · Parte 3: eCommerce",
    subject: "eCommerce con IA",
    href: "/ebook/creacion-de-webs-con-ia-parte-3",
    coverSrc: "/ebooks/creacion-de-webs-con-ia-parte-3.png",
    active: true,
    tierPrices: { superEarly: 9700, early: 13700, regular: 19700 },
    storeProfile: {
      level: "Constructor",
      outcome: "Construir un eCommerce completo con catálogo, carrito, checkout y pagos reales.",
      audience: "Si quieres desarrollar tiendas online con Next.js y validar flujos que involucran dinero.",
      pageCount: 129,
    },
    visibleFrom: LANZAMIENTO_2026_08_07,
    series: { name: "Creación de Webs con IA", part: 3 },
  },
  {
    resource: "ebook:creacion-de-webs-con-ia-parte-4",
    title: "Creación de Webs con IA · Parte 4: SaaS y Dashboards",
    subject: "SaaS y Dashboards con IA",
    href: "/ebook/creacion-de-webs-con-ia-parte-4",
    coverSrc: "/ebooks/creacion-de-webs-con-ia-parte-4.png",
    active: true,
    tierPrices: { superEarly: 9700, early: 13700, regular: 19700 },
    storeProfile: {
      level: "Constructor",
      outcome: "Construir productos SaaS con autenticación, datos en vivo y multi-tenancy.",
      audience: "Si quieres pasar de una landing a una aplicación web con usuarios y datos reales.",
      pageCount: 114,
    },
    visibleFrom: LANZAMIENTO_2026_08_07,
    series: { name: "Creación de Webs con IA", part: 4 },
  },
];
